...
<head>
  <title>Tuỳ chỉnh nhà cung cấp | Quản trị Admin</title>
  <meta charset="utf-8">
...
<body class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item active" href="supplier-management.html"><i class='app-menu__icon bx bxs-user-account'></i><span
