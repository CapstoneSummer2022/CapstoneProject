...
<head>
  <title>Thêm kho hàng | Quản trị Admin</title>
  <meta charset="utf-8">
          ...
          <div class="tile-body">
            <form class="row">
              <div class="form-group col-md-4">
                <label class="control-label">Mã kho hàng</label>
              ...
              <div class="form-group col-md-4 ">
                ...
                <select class="form-control" id="exampleSelect1">
                  ...
                  <option>Đang sửa dụng</option>
                  <option>Không còn sử dụng hàng</option>
                </select>
              </div>
            </form>
          </div>
          <button class="btn btn-save" type="button">Lưu lại</button>
          <a class="btn btn-cancel" href="warehouse-management.html">Hủy bỏ</a>
        </div>
  </main>
