...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item active" href="system-account-management.html"><i class='app-menu__icon bx bx-id-card'></i>
          <span class="app-menu__label">Quản lý tài khoản</span>
        </a>
        <ul class="sub-app-menu">
          <li><a class="sub-app-menu_item" href="system-account-management.html"><span
                class="app-menu__label">Tài khoản hệ thống</span></a></li>
          <li><a class="sub-app-menu_item sub-item-active" href="customer-management.html"><span class="app-menu__label">Tài khoản khách
                hàng</span></a></li>
        </ul>
      </li>
